 ...
 * index 1: 4 màu vàng tương ứng từ indexStar 0 - 3 đều màu vàng
 * index 2: 3 màu vàng tương ứng từ indexStar 0 - 2 đều màu vàng
 * index 3: 2 màu vàng tương ứng từ indexStar 0 - 1 đều màu vàng
 * index 4: 1 màu vàng tương ứng từ indexStar 0 đều màu vàng
 *
 * => indexStart < 5 - index => vàng
 */

interface ReatingStarProps {
  queryConfig: QueryConfig
}

export default function RatingStarts({ queryConfig }: ReatingStarProps) {
